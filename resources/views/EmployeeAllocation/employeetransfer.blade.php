            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        ...
                        <br>
                        <table class="table table-striped table-bordered table-sm small nowrap" id="tblcopylist" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#create_record').click(function () {
                ...
                $('#todrop ').show();
                $('#serchsection').show();
                $('.modal-title').text('New Security Guards Transfer');
                $('#btncreateorder').html('Create Transfer');
                $('#action').val('Add');
        ...
        $('#serachbtn').click(function () {
            var subregion_from = $('#subregion_from').val();
        ...
        var toDateValue = $(this).closest('tr').find('input[name="todate"]').val();
         ...
         // Check if the checkbox is checked, and if not, check it
        ...
        $('#btncreateorder').click(function () {
                ...
                $("#tblcopylist tbody tr").each(function () {
                    ...
                    $(this).find('td').each(function (col_idx) {
                        if (col_idx === 5) { 
                            item["col_6"] = $(this).find('input[name="fromdate"]').val();
                        } else if (col_idx === 6) { 
                            item["col_7"] = $(this).find('input[name="todate"]').val();
                        } else {
                            item["col_" + (col_idx + 1)] = $(this).text();
                        }
                    });
         ...
         $(document).on('click', '.view', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#approve_button').hide();
                    $('#approveconfirmModal').modal('show');
                    $('.modal-title').text('View Security Guard Transfer');
