...
<main>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record"
                            id="create_record"><i class="fas fa-plus mr-2"></i>Add Asset Particular</button>
                            @endif
                    </div>
                    <div class="col-12">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Asset Particular</h5>
   ...
   <div class="modal-dialog modal-dialog-centered">
       <div class="modal-content">
           <div class="modal-header p-2">
               <h5 class="Editmodal-title" id="staticBackdropLabel">Edit Asset Particular</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
               </button>
           </div>
                   ...
                   <div class="col">
                       ...
                       <form method="post" id="formTitle1" class="form-horizontal">
                           ...
                           <div class="form-row mb-1">
                               <div class="col-12">
                                   <label class="small font-weight-bold text-dark">Asset Category*</label>
                                   <select name="editasset_category" id="editasset_category" class="form-control form-control-sm"
                                            required>
                                            <option value="">Select Category</option>
                                            @foreach($assetcategories as $assetcategorie)
                                            <option value="{{$assetcategorie->id}}">{{$assetcategorie->asset_category}}</option>
    ...
    <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="approvelmodal-title" id="staticBackdropLabel">Approve Asset Particular</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script>
   ...
   $('#corporate_link').addClass('active');
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Add New Asset Particular');
            $('#action').val('Add');
            $('#form_result').html('');
            $('#formTitle')[0].reset();
        ...
        $('#btncreateorder').click(function () {
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('assetparticularinsert') }}";
            }
            if ($('#action').val() == 'Edit') {
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#editasset_category').val(data.result.asset_category_id);

                    $('#edithidden_id').val(id);
                    $('.modal-title').text('Edit Asset Particular');
...
$('#action_button').click(function ()  {
            ...
            var asset_category = $('#editasset_category').val();
            ...
            $.ajax({
                url: '{!! route("assetparticularupdate") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    hidden_id: id,
        ...
        $('#ok_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("assetparticulardelete") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: user_id
        ...
        $('#approve_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("assetparticularapprove") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_hidden,
