    ...
    <main>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Add Asset Category</h5>
        ...
        <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="approveconfirmmodal-title" id="staticBackdropLabel">Approve Asset Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@section('script')
   ...
   $('#corporate_link').addClass('active');
            ...
            $('#create_record').click(function(){
                $('.modal-title').text('Add New Asset Category');
            ...
            $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('assetcategoryinsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('assetcategoryupdate') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    url: '{!! route("assetcategoryedit") !!}',
                        type: 'POST',
                        dataType: "json",
                        data: {id: id },
                    success: function (data) {
                        $('#category').val(data.result.asset_category);

                        $('#hidden_id').val(id);
                        $('.modal-title').text('Edit Asset Category');
        ...
        var id_approve;
            ...
            $(document).on('click', '.appL1', function () {
                ...
                $.ajax({
                    url: '{!! route("assetcategoryedit") !!}',
                        ...
                        data: {id: id_approve },
                    success: function (data) {
                        $('#app_category').val(data.result.asset_category);
            ...
            $('#approve_button').click(function () {
                ...
                $.ajax({
                    url: '{!! route("assetcategoryapprove") !!}',
                        type: 'POST',
                        dataType: "json",
                        data: {id: id_hidden,
                            applevel: applevel },
