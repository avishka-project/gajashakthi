    ...
    <div class="container-fluid">
        <div class="page-header-content py-3">
            <h1 class="page-header-title">
                ...
                <span>Vehicle Service & Rapair</span>
            </h1>
        </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record"
                            id="create_record"><i class="fas fa-plus mr-2"></i>Add Vehicle Service & Rapair</button>
                            @endif
                    </div>
                    <div class="col-12">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Vehicle Service & Rapair</h5>
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-row mb-1">
                            <div class="col">
                                <label class="small font-weight-bold text-dark">Vehicle Number*</label>
                                <input type="text" id="app_vehicle_number" name="app_vehicle_number" class="form-control form-control-sm"
                                    required readonly>
                            </div>
                    </div>
                        <div class="form-row mb-1">
...
<script>
    $(document).ready(function () {
        ...
        $('#vehicleserviceandrepair_link').addClass('active');

        $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                "url": "{!! route('vehicleserviceandrepairlist') !!}",
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Add New Vehicle Service & Rapair');
        ...
        $('#formTitle').on('submit', function (event) {
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('vehicleserviceandrepairinsert') }}";
            }
            if ($('#action').val() == 'Edit') {
                action_url = "{{ route('vehicleserviceandrepairupdate') }}";
            }
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                url: '{!! route("vehicleserviceandrepairedit") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id
                ...
                success: function (data) {
                    ...
                    $('#hidden_id').val(id);
                    $('.modal-title').text('Edit Vehicle Service & Rapair');
        ...
        $('#ok_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("vehicleserviceandrepairdelete") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: user_id
        ...
        $(document).on('click', '.appL1', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#app_vehicle_number').val(data.result.vehicle_number);
        ...
        $('#approve_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("vehicleserviceandrepairapprove") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_hidden,
        ...
        $(document).on('click', '#reject_button', function () {
            ...
            $('#reject_ok_button').click(function () {
                ...
                $.ajaxSetup({
                    ...
                    $.ajax({
                url: '{!! route("vehicleservicereject") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: reject_id,
