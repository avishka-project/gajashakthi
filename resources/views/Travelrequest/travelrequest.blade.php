    ...
    <div class="page-header page-header-light bg-white shadow">
        ...
        <div class="page-header-content py-3">
            <h1 class="page-header-title">
                <div class="page-header-icon"><i class="fas fa-bus-alt"></i></div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Travel Request</h5>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <input type="hidden" name="travelrequestsid" id="travelrequestsid">
                            </form>
                        </div>
                        <div class="col-8">
...
<script>
    $(document).ready(function () {
        ...
        $('#travelrequest_link').addClass('active');
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Add New Travel  Request');
        ...
        $('#btncreateorder').click(function () {
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('travelrequestinsert') }}";
            }
            if ($('#action').val() == 'Edit') {
                action_url = "{{ route('travelrequestupdate') }}";
            }
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#amount').val(data.result.mainData.amount);
        ...
        $(document).on('click', '.btnEditlist', function () {
            ...
            $.ajax({
                url: '{!! route("travelrequestdetailedit") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id
                ...
                success: function (data) {
                    ...
                    $('#travelrequestsid').val(data.result.id);
                    $('#Btnupdatelist').show();
                    $('#formsubmit').hide();
                }
            })
        ...
        $(document).on("click", "#Btnupdatelist", function () {
            var EmployeeID = $('#employee').val();
            var Employee = $("#employee option:selected").text();
            var detailid = $('#travelrequestsid').val();
        ...
        $('#ok_button2').click(function () {
            ...
            $.ajax({
                url: '{!! route("travelrequestdetaildelete") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: rowid
        ...
        $(document).on('click', '.appL1', function () {
            ...
            $.ajax({
                url: '{!! route("travelrequestdetailapprovel_details") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_approve
        ...
        $('#approve_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("travelrequestapprove") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_hidden,
