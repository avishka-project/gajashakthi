    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body p-0 p-2">
                    <div class="row">
                        <div class="col-12">
                                <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Sub Customers</button>
                        </div>
                        <div class="col-12">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Add Sub Customers</h5>
        ...
        <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Approve Sub Customer Details</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#subcustomer_link').addClass('active');

            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    "url": "{!! route('subcustomerlist') !!}",
            ...
            $('#create_record').click(function(){
                $('.modal-title').text('Add New Sub Customer');
            ...
            $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('subcustomerinsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('subcustomerupdate') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    url: '{!! route("subcustomeredit") !!}',
                        type: 'POST',
                        dataType: "json",
                        data: {id: id },
                    success: function (data) {
                        $('#cusname').val(data.result.sub_name);
                        ...
                        $('#hidden_id').val(id);
                        $('.modal-title').text('Edit Sub Customer');
            ...
            $(document).on('click', '.appL1', function () {
                ...
                $.ajax({
                    url: '{!! route("subcustomeredit") !!}',
                        ...
                        data: {id: id_approve },
                    success: function (data) {
                        $('#app_cusname').val(data.result.sub_name);
                        ...
                        if (valueToCheck == 1 ) {
                            $('#app_payby').val('Company');
                        } else {
                            $('#app_payby').val('Branch');
                        }
