    ...
    <main>
                                ...
                                <div class="form-row mb-1">
                                    <div class="col-12">
                                        ...
                                        <select name="subcustomer" id="subcustomer"
                                            ...
                                            @foreach($subclients as $subcustomers)
                                    ...
                                    <div class="col-12">
                                        ...
                                        <br>
                                        <input type="text" name="line_3" id="line_3" class="form-control form-control-sm" placeholder="Line 3" />
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Approve Branch Details</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-row mb-1">
                                <div class="col-12">
                                <label class="small font-weight-bold text-dark">Client</label>
                                <select name="app_customer_id" id="app_customer_id" class="form-control form-control-sm" readonly>
...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#cusbranch_link').addClass('active');

           var branchStatusactive = '{{ route("branchstatus", ["id" => "cus_id", "status" => 1]) }}';
           var branchStatusdeactive = '{{ route("branchstatus", ["id" => "cus_id", "status" => 2]) }}';
           var branchContact = '{{ route("branchcontact", ["id" => "cus_id"]) }}';
            ...
            $('#dataTable').DataTable({
                ...
                "serverSide": true,
                ajax: {
                    url: scripturl + '/customerbranchlist.php',
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, full) {
                            ...
                            button+='<a href="' + branchContact.replace('cus_id', full['id'])+'" target="_self" class="btn btn-info btn-sm mr-1 "><i class="fas fa-phone"></i></a>';
                            if(full['status']==1){
                                button+='<a href="' + branchStatusdeactive.replace('cus_id', full['id'])+'" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1"><i class="fas fa-check"></i></a>';
                            }else{
                                button+='<a href="' + branchStatusactive.replace('cus_id', full['id'])+'" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1"><i class="fas fa-times"></i></a>';
                            }
            ...
            $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('branchinsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('branchupdate') }}";
                }
        ...
        var id_approve;
            ...
            $(document).on('click', '.appL1', function () {
                ...
                $.ajax({
                    url: '{!! route("branchedit") !!}',
                        ...
                        data: {id: id_approve },
                    success: function (data) {
                        $('#app_cusname').val(data.result.branch_name);
                        ...
                        $('#app_customer_id').val(data.result.customer_id);
                        $('#app_subcustomer').val(data.result.subcustomer_id);
            ...
            if (customerId !== '') {
                $.ajax({
                    url: '{!! route("branchgetsubcustomers", ["customerId" => "id_customer"]) !!}'
