                                    ...
                                    <div class="form-row mb-1">
                                        ...
                                        <select name="customer_id" id="customer_id" class="form-control form-control-sm" required>
                                            ...
                                            @foreach($customer as $customers)
                                                <option value="{{$customers->id}}">{{$customers->sub_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#dataTable').DataTable({
                ...
                "serverSide": true,
                ajax: {
                    url: '{{ url('/') }}/scripts/customerbranchlist.php',
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, full) {
                            return full['address1']+' '+full['address2']+''+full['city'];
                        }
                    },
                    {
                        "targets": -1,
                        ...
                        "render": function(data, type, full) {
                            ...
                            if(full['status']==1){
                                button+='<a href="{{ url('/') }}/User/Useraccountstatus/'+full['id']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1"><i class="fas fa-check"></i></a>';
                            }else{
                                button+='<a href="{{ url('/') }}/User/Useraccountstatus/'+full['id']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1"><i class="fas fa-times"></i></a>';
                            }
                            button+='<a href="{{ url('/') }}/User/Useraccountstatus/'+full['id']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>';
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#customer_id').val(data.result.subcustomer_id);
            ...
            $(document).on('click', '.appL1', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#app_customer_id').val(data.result.subcustomer_id);
