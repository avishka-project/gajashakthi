...
<main>
            ...
            <div class="card-body p-0 p-2">
                <div class="row">
                    ...
                    <div class="col-12" style="margin-bottom: 20px;">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right viewDocument"
                            name="viewpdf" id="viewpdf" style="margin-left: 10px;"><i class="fa fa-download"></i>Get
                            Document</button>
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <select hidden name="subcustomer" id="subcustomer"
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" id="formTitle2" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <select hidden name="subcustomer2" id="subcustomer2"
                                        class="form-control form-control-sm">
                                        <option value="">Select Sub Client</option>
                                    </select>
    ...
    <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Approve Authorized Cadre Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" id="formTitle3" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <select hidden name="app_subcustomer" id="app_subcustomer"
                                        class="form-control form-control-sm">
                                        <option value="">Select Sub Client</option>
    ...
    <div class="modal fade" id="viewModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="viewmodal-title" id="staticBackdropLabel">View Authorized Cadre Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" id="formTitle3" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <select hidden name="view_subcustomer" id="view_subcustomer"
                                        class="form-control form-control-sm">
                                        <option value="">Select Sub Client</option>
                                        @foreach($subcustomer as $subcustomers)
                                        <option value="{{$subcustomers->id}}">{{$subcustomers->sub_name}}</option>
    ...
    <div class="modal fade" id="specialrequestformModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="specialrequestmodal-title" id="staticBackdropLabel">Create Special Authorized Cadre</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" id="special_formTitle" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <select hidden name="speacial_subcustomer" id="speacial_subcustomer"
                                        class="form-control form-control-sm">
                                        <option value="">Select Sub Client</option>
                                    </select>
    ...
    <div class="modal fade" id="editspecialrequestformModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="editspecialrequestmodal-title" id="staticBackdropLabel">Edit Special Authorized Cadre
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <div class="modal fade" id="special_approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="special_modal-title" id="staticBackdropLabel">Approve Authorized Cadre Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" id="special_formTitle" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <select hidden name="special_app_subcustomer" id="special_app_subcustomer"
                                        class="form-control form-control-sm">
                                        <option value="">Select Sub Client</option>
                                        @foreach($subcustomer as $subcustomers)
                                        <option value="{{$subcustomers->id}}">{{$subcustomers->sub_name}}</option>
    ...
    <div class="modal fade" id="special_viewModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="special_viewmodal-title" id="staticBackdropLabel">View Authorized Cadre Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" id="special_formTitle3" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <select hidden name="special_view_subcustomer" id="special_view_subcustomer"
                                        class="form-control form-control-sm">
                                        <option value="">Select Sub Client</option>
                                        @foreach($subcustomer as $subcustomers)
                                        <option value="{{$subcustomers->id}}">{{$subcustomers->sub_name}}</option>
                                    ...
                                    <div class="col-3">
                                        <label class="small font-weight-bold text-dark">Branch*</label>
                                        <select name="special_view_area" id="special_view_area"
                                            class="form-control form-control-sm" required>
                                            <option value="">Select Branch</option>
                                            @foreach($areas as $area)
                                            <option value="{{$area->id}}">{{$area->branch_name}}</option>
                                    ...
                                    <div class="col-3">
                                        <label class="small font-weight-bold text-dark">From Date*</label>
                                        <input type="date" class="form-control form-control-sm" placeholder=""
                                            name="special_view_fromdate" id="special_view_fromdate"
                                            value="<?php echo date('Y-m-d') ?>" required>
                                    </div>
                                    <div class="col-3">
                                        <label class="small font-weight-bold text-dark">To Date*</label>
                                        <input type="date" class="form-control form-control-sm" placeholder=""
                                            name="special_view_todate" id="special_view_todate"
                                            value="<?php echo date('Y-m-d') ?>" required>
                                    </div>
                                    <input type="hidden" name="special_view_subregion_id"
                                        id="special_view_subregion_id">
                                </div>

                                <hr>
                                <table class="table table-striped table-bordered table-sm small"
                                    id="special_view_tableorder">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            @foreach($specialholidays as $holiday)
    ...
    {{-- document view model --}}
    <div class="modal fade" id="document_viewModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="document_viewmodal-title" id="staticBackdropLabel">View Authorized Cadre Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <span id="document_form_result2"></span>
                            <table class="table table-striped table-bordered table-sm small nowrap display"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>To Date</th>
                                        <th>Week Days-Day</th>
                                        <th>Week Days-Night</th>
                                        <th>Saturdays-Day</th>
                                        <th>Saturdays-Night</th>
                                        <th>Sundays-Day</th>
                                        <th>Sundays-Night</th>
                                        <th>Holidays-Day</th>
                                        <th>Holidays-Night</th>
                                        <th>Special Days-Day</th>
                                        <th>Special Days-Night</th>
                                        <th>Special Assignment Days-Day</th>
                                        <th>Special Assignment Days-Night</th>
                                    </tr>
                                </thead>
                                <tbody id="tbldocumentbody"></tbody>
                                <tfoot>
                                    <tr>
                                        <th colspan="7"></th>
                                        <th id="weekday_day"></th>
                                        <th id="weekday_night"></th>
                                        <th id="saturday_day"></th>
                                        <th id="saturday_night"></th>
                                        <th id="sunday_day"></th>
                                        <th id="sunday_night"></th>
                                        <th id="holiday_day"></th>
                                        <th id="holiday_night"></th>
                                        <th id="specialday_day"></th>
                                        <th id="specialday_night"></th>
                                        <th id="specialassigmentday_day"></th>
                                        <th id="specialassigmentday_night"></th>
                                        <!-- <th></th> -->
                                    </tr>
                                </tfoot>
                            </table>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#dataTable').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: scripturl + '/authorizedcadrerlist.php',
            ...
            "buttons": [{
                    ...
                    title: 'Authorized Cadre Header Details',
                        ...
                        if (approvel01) {
                            if (full['approve_01'] == 0) {
                                if (full['requeststatus'] == "Normal") {
                                    ...
                                    button += ' <button name="special_appL1" id="' + full['id'] + '" class="special_appL1 btn btn-outline-danger btn-sm" type="submit"><i class="fas fa-level-up-alt"></i></button>';
                                }
                            }
                        }
                        if (approvel02) {
                            if (full['approve_01'] == 1 && full['approve_02']==0) {
                                if (full['requeststatus'] == "Normal") {
                                    ...
                                    button += ' <button name="special_appL2" id="' + full['id'] + '" class="special_appL2 btn btn-outline-warning btn-sm" type="submit"><i class="fas fa-level-up-alt"></i></button>';
                                }
                            }
                        }
                        if (approvel03) {
                            if (full['approve_02'] == 1 && full['approve_03']==0) {
                                if (full['requeststatus'] == "Normal") {
                                    ...
                                    button += ' <button name="special_appL3" id="' + full['id'] + '" class="special_appL3 btn btn-outline-info btn-sm" type="submit"><i class="fas fa-level-up-alt"></i></button>';
                                }
                            }
                        }
                        if (editcheck) {
                            if (full['approve_03']==1) {
                                if (full['requeststatus'] == "Normal") {
                                    ...
                                    button += ' <button name="specialview" id="' + full['id'] + '" class="specialview btn btn-outline-secondary btn-sm" type="submit"><i class="fas fa-eye"></i></button>';
                                }
                            }
                        }
                        if (editcheck) {
                                if (full['requeststatus'] == "Normal") {
                                    ...
                                    button += ' <button name="specialedit" id="' + full['id'] + '" class="specialedit btn btn-outline-primary btn-sm" type="submit"><i class="fas fa-pencil-alt"></i></button>';
                                }
                        }
                        if (statuscheck) {
                                if (full['status'] == 1) {
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Create Authorized Cadre');
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#hidden_id2').val(id);
                    $('.modal-title2').text('Edit Authorized Cadre');
...
<script>
    ...
    function speacial_calculateTotal3() {
        ...
        for (var holidayName in holidayTotals3) {
            document.getElementById('special_app_' + holidayName + '_daytotal').textContent = holidayTotals3[
                    holidayName]
                .dayTotal;
            document.getElementById('special_app_' + holidayName + '_nighttotal').textContent = holidayTotals3[
                    holidayName]
                .nightTotal;
        }
    }
    ...
    function speacial_calculateTotal4() {
        ...
        for (var holidayName in holidayTotals3) {
            document.getElementById('special_view_' + holidayName + '_daytotal').textContent = holidayTotals3[
                    holidayName]
                .dayTotal;
            document.getElementById('special_view_' + holidayName + '_nighttotal').textContent = holidayTotals3[
                    holidayName]
                .nightTotal;
        }
    }
...
<script>
    ...
    $('#special_viewModal').on('hidden.bs.modal', function () {
     ...
     // document view form reset
     $('#document_viewModal').on('hidden.bs.modal', function () {
    $('#tbldocument').DataTable().destroy();
    $('#tbldocumentbody').empty();
    });
</script>
...
<script>
     function detailstable(){
        ...
        var weekday_night = 0;
        var saturday_day = 0;
        var saturday_night = 0;
        var sunday_day = 0;
        var sunday_night = 0;
        var holiday_day = 0;
        var holiday_night = 0;
        var specialday_day = 0;
        var specialday_night = 0;
        var specialassigmentday_day = 0;
        var specialassigmentday_night = 0;
            ...
            "responsive": true,
            ajax: {
                url: scripturl + '/cadrerdetailslist.php',

                type: "POST", // you can use GET


            },
            dom: "<'row'<'col-sm-7'B><'col-sm-5'f>>" + "<'row'<'col-sm-12'tr>>" +
                "<'row'<'col-sm-5'i>>",

            "buttons": [{
                    extend: 'csv',
                    className: 'btn btn-success btn-sm',
                    title: 'Authorized Cadre Details - Gajashakthi Security Service (PVT) LTD',
                    text: '<i class="fas fa-file-csv mr-2"></i> CSV',
                },
                // { 
                //     extend: 'print', 
                //     title: 'Authorized Cadre Details',
                //     className: 'btn btn-primary btn-sm', 
                //     text: '<i class="fas fa-print mr-2"></i> Print',
                //     customize: function ( win ) {
                //         $(win.document.body).find( 'table' )
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 3) {
                            if (full['shift_id'] == 2) {
                                weekday_day=weekday_day+parseInt(full['count']);
                                $('#weekday_day').text(weekday_day);
                                return full['count'];
                            } else {
                                return '';
                            }
                    ...
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 3) {
                            if (full['shift_id'] == 3) {
                                weekday_night=weekday_night+parseInt(full['count']);
                                $('#weekday_night').text(weekday_night);
                                return full['count'];
                            } else {
                                return '';
                            }
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 4) {
                            if (full['shift_id'] == 2) {
                                saturday_day=saturday_day+parseInt(full['count']);
                                $('#saturday_day').text(saturday_day);
                                return full['count'];
                            } else {
                                return '';
                            }
                    ...
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 4) {
                            if (full['shift_id'] == 3) {
                                saturday_night=saturday_night+parseInt(full['count']);
                                $('#saturday_night').text(saturday_night);
                                return full['count'];
                            } else {
                                return '';
                            }
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 5) {
                            if (full['shift_id'] == 2) {
                                sunday_day=sunday_day+parseInt(full['count']);
                                $('#sunday_day').text(sunday_day);
                                return full['count'];
                            } else {
                                return '';
                            }
                    ...
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 5) {
                            if (full['shift_id'] == 3) {
                                sunday_night=sunday_night+parseInt(full['count']);
                                $('#sunday_night').text(sunday_night);
                                return full['count'];
                            } else {
                                return '';
                            }
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 1) {
                            if (full['shift_id'] == 2) {
                                holiday_day=holiday_day+parseInt(full['count']);
                                $('#holiday_day').text(holiday_day);
                                return full['count'];
                            } else {
                                return '';
                            }
                    ...
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 1) {
                            if (full['shift_id'] == 3) {
                                holiday_night=holiday_night+parseInt(full['count']);
                                $('#holiday_night').text(holiday_night);
                                return full['count'];
                            } else {
                                return '';
                            }
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 2) {
                            if (full['shift_id'] == 2) {
                                specialday_day=specialday_day+parseInt(full['count']);
                                $('#specialday_day').text(specialday_day);
                                return full['count'];
                            } else {
                                return '';
                            }
                    ...
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 2) {
                            if (full['shift_id'] == 3) {
                                specialday_night=specialday_night+parseInt(full['count']);
                                $('#specialday_night').text(specialday_night);
                                return full['count'];
                            } else {
                                return '';
                            }
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 6) {
                            if (full['shift_id'] == 2) {
                                specialassigmentday_day=specialassigmentday_day+parseInt(full['count']);
                                $('#specialassigmentday_day').text(specialassigmentday_day);
                                return full['count'];
                            } else {
                                return '';
                            }
                    ...
                    "render": function (data, type, full) {
                        if (full['holiday_id'] == 6) {
                            if (full['shift_id'] == 3) {
                                specialassigmentday_night=specialassigmentday_night+parseInt(full['count']);
                                $('#specialassigmentday_night').text(specialassigmentday_night);
                                return full['count'];
                            } else {
                                return '';
                            }
