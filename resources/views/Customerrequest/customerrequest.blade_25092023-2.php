                                ...
                                <table class="table table-striped table-bordered table-sm small" id="tableorder">
                                    ...
                                    <tfoot>
                                        <tr style="font-weight: bold;font-size: 16px; background-color:#ffffbb">
                                            <td>Total:</td>
                                            @foreach($holidays as $holiday)
                                            <th id="{{$holiday->name}}_daytotal" class="text-center">0</th>
                                            <th id="{{$holiday->name}}_nighttotal" class="text-center">0</th>
                                            @endforeach
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table class="table table-striped table-bordered table-sm small" id="tableorder2">
                                    ...
                                    <tfoot>
                                        <tr style="font-weight: bold;font-size: 16px; background-color:#ffffbb">
                                            <td>Total:</td>
                                            @foreach($holidays as $holiday)
                                            <th id="{{$holiday->name}}_daytotal2" class="text-center">0</th>
                                            <th id="{{$holiday->name}}_nighttotal2" class="text-center">0</th>
                                            @endforeach
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table class="table table-striped table-bordered table-sm small" id="app_tableorder">
                                    ...
                                    <tfoot>
                                        <tr style="font-weight: bold;font-size: 16px; background-color:#ffffbb">
                                            <td>Total:</td>
                                            @foreach($holidays as $holiday)
                                            <th id="app_{{$holiday->name}}_daytotal" class="text-center">0</th>
                                            <th id="app_{{$holiday->name}}_nighttotal" class="text-center">0</th>
                                            @endforeach
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table class="table table-striped table-bordered table-sm small" id="view_tableorder">
                                    ...
                                    <tfoot>
                                        <tr style="font-weight: bold;font-size: 16px; background-color:#ffffbb">
                                            <td>Total:</td>
                                            @foreach($holidays as $holiday)
                                            <th id="view_{{$holiday->name}}_daytotal" class="text-center">0</th>
                                            <th id="view_{{$holiday->name}}_nighttotal" class="text-center">0</th>
                                            @endforeach
                                        </tr>
                                    </tfoot>
                                </table>
...
<script>
    ...
    $('#editspecialrequestformModal').on('hidden.bs.modal', function () {
        ...
        // Reset the select options
        $('#speacial_customer2, #speacial_subcustomer2, #speacial_area2, #speacial_holidaytype2, #speacial_shift2, #speacial_title2')
            .val('').trigger('change');
