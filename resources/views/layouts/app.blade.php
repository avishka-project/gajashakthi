...
<body class="nav-fixed">
    <div id="app">
        <nav class="topnav navbar navbar-expand shadow navbar-light topnavbarcolor" id="sidenavAccordion">
            <a class="navbar-brand d-none d-sm-block topbarcolor" href="{{ url('/home') }}" style="color: #ffffff">
                Gaja Shakthi HRM
            </a>
            ...
            <ul class="navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item no-caret mr-3">
                    <a href="https://aws.erav.lk/gajashakthipay" title="Goto Payroll System"
                        class="text-decoration-none  topbarcolor"><i class="fas fa-book"></i>&nbsp;Payroll</a>
                </li>
            ...
            <div id="layoutSidenav_content">
                ...
                <footer class="footer mt-auto footer-light">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 small">Copyright &copy; Gaja Shakthi Security Services
                                <?php echo date('Y') ?>
