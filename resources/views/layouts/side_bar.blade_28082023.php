<nav class="sidenav shadow-right sidenavbarcolor">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse" id="collapseCorporation" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 collapsed sidebar-text-color" id="vehiclelist"
                        ...
                        aria-expanded="false" aria-controls="collapseDashboards">
                        <div class="nav-link-icon"></div> Vehicle
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
            ...
            || auth()->user()->can('allocation-list') || auth()->user()->can('specialrequest-approvelist')
            ...
            <div class="collapse" id="collapseemployee" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 collapsed sidebar-text-color" id="office_staff_main_nav_link"
                        href="#" data-toggle="collapse" data-target="#office_staff_collapse" aria-expanded="false"
                        aria-controls="collapseDashboards">
                        <div class="nav-link-icon"></div>
                        Office Staff
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse" id="office_staff_collapse" data-parent="#accordionSidenavPages">
                        <nav class="sidenav-menu-nested nav accordion" id="office_staff_submenu">
                            ...
                            <a class="nav-link p-0 px-3 py-1 collapsed sidebar-text-color" id="employee_main_nav_link"
                                href="#" data-toggle="collapse" data-target="#employee_collapse" aria-expanded="false"
                                aria-controls="collapseLayouts">
                                <div class="nav-link-icon"></div>
                                Employee Details
                                <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="employee_collapse" data-parent="#accordionSidenavPages">
                                <nav class="sidenav-menu-nested nav accordion" id="employee_submenu">
                                    <a class="nav-link p-0 px-3 py-1 sidebar-text-color" id="employee_add_link"
                                        href="{{ route('addEmployee') }}">Employee Details</a>
                                </nav>
                            </div>
                    ...
                    <a class="nav-link p-0 px-3 py-1 collapsed sidebar-text-color" id="security_staff_main_nav_link"
                        href="#" data-toggle="collapse" data-target="#security_staff_collapse" aria-expanded="false"
                        aria-controls="collapseDashboards">
                        <div class="nav-link-icon"></div>
                        Security Staff
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse" id="security_staff_collapse" data-parent="#accordionSidenavPages">
                        <nav class="sidenav-menu-nested nav accordion" id="security_staff_submenu">
...
<a class="nav-link p-0 px-3 py-2 collapsed sidebar-text-color" href="javascript:void(0);" data-toggle="collapse"
    data-target="#collapscustomer" aria-expanded="false" aria-controls="collapscustomer">
...
<div class="collapse" id="collapscustomer" data-parent="#accordionSidenav">
    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
        <a class="nav-link p-0 px-3 py-1 collapsed sidebar-text-color" id="customerlist" href="#" data-toggle="collapse"
            data-target="#customerlistdrop" aria-expanded="false" aria-controls="collapseDashboards">
            <div class="nav-link-icon"></div>
            Master Data
            <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
        </a>
        <div class="collapse" id="customerlistdrop" data-parent="#accordionSidenavPages">
            <nav class="sidenav-menu-nested nav accordion" id="customer_submenu">
                ...
                <a class="nav-link p-0 px-3 py-1 sidebar-text-color" id="customer_link"
                    href="{{ route('customers')}}">Customer</a>
                @endcan
                ...
                @endcan
                @can('branch-list')
                <a href="{{ route('branchers')}}" id="branch_link" class="nav-link p-0 px-3 py-1 sidebar-text-color">
                    Customer
                    Branch</a>
                @endcan
                @can('customercategory-list')
                <a href="{{ route('cuscategory')}}" id="category_link"
                    class="nav-link p-0 px-3 py-1 sidebar-text-color"> Customer
                    Category</a>
                @endcan
            </nav>
        </div>
...
|| auth()->user()->can('leave-list') || auth()->user()->can('leave-type-list') || auth()->user()->can('leave-approve')
|| auth()->user()->can('holiday-list'))

<a class="nav-link p-0 px-3 py-2 collapsed sidebar-text-color" href="javascript:void(0);" data-toggle="collapse"
    data-target="#collapse_employee_info" aria-expanded="false" aria-controls="collapse_employee_info">
    <div class="nav-link-icon"><i class="fas fa-users"></i></div>
    Attendance & Leave
    <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
</a>
<div class="collapse" id="collapse_employee_info" data-parent="#accordionSidenavPages">
    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
        <a class="nav-link p-0 px-3 py-2 collapsed sidebar-text-color" href="javascript:void(0);" data-toggle="collapse"
            data-target="#collapsattendance" aria-expanded="false" aria-controls="collapsattendance">
        ...
        <a class="nav-link p-0 px-3 py-2 collapsed sidebar-text-color" href="javascript:void(0);" data-toggle="collapse"
            data-target="#collapsleave" aria-expanded="false" aria-controls="collapsleave">
        ...
        <div class="collapse" id="collapsleave" data-parent="#accordionSidenav">
            <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                <a class="nav-link p-0 px-3 py-1 collapsed sidebar-text-color" id="leavemasters_main_nav_link"
                    href="javascript:void(0);" data-toggle="collapse" data-target="#leavemaster_collapse"
                    aria-expanded="false" aria-controls="collapseLayouts">
                    <div class="nav-link-icon"></div>
                    Master Data
                    <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
...
<a class="nav-link p-0 px-3 py-2 collapsed sidebar-text-color" href="javascript:void(0);" data-toggle="collapse"
    data-target="#collapreports" aria-expanded="false" aria-controls="collapreports">
...
<div class="collapse" id="collapreports" data-parent="#accordionSidenav">
    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
        <a class="nav-link p-0 px-3 py-1 collapsed sidebar-text-color" id="report_main_nav_link"
            href="javascript:void(0);" data-toggle="collapse" data-target="#report_collapse" aria-expanded="false"
            aria-controls="collapseLayouts">
            <div class="nav-link-icon"><i class="fas fa-file"></i></div>
            Employee Reports
            <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
...
<a class="nav-link p-0 px-3 py-2 collapsed sidebar-text-color" href="javascript:void(0);" data-toggle="collapse"
    data-target="#collapadministrator" aria-expanded="false" aria-controls="collapadministrator">
