<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <a class="nav-link p-0 px-3 py-2" id="dashboard_link" href="{{ route('emptypes')}}">
            ...
            <div class="collapse" id="regionlistdrop" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    @endcan
                        @can('Sub-Region-list')
                            <a href="{{ route('subregions')}}" id="area_link" class="nav-link p-0 px-3 py-2" > Sub Region </a>
                        @endcan
                </nav>
            </div>
            @endif  
            @if(auth()->user()->can('customer-list') || auth()->user()->can('branch-list') || auth()->user()->can('customercategory-list') )
                ...
                <div class="collapse" id="customerlistdrop" data-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                        ...
                        @endcan
                            @can('branch-list')
                                <a href="{{ route('branchers')}}" id="area_link" class="nav-link p-0 px-3 py-2" > Customer Branch</a>
                            @endcan
                            @can('customercategory-list')
                            <a href="{{ route('cuscategory')}}" id="area_link" class="nav-link p-0 px-3 py-2" > Customer Category</a>
                        @endcan
                    </nav>
                </div>
            @endif 
            @if(auth()->user()->can('CustomerRequest-list'))
            <a class="nav-link p-0 px-3 py-2" id="dashboard_link" href="{{ route('customerrequest') }}">
                <div class="nav-link-icon"><i class="fas fa-users"></i></div>
