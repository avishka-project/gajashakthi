                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record"
                            id="create_record"><i class="fas fa-plus mr-2"></i>Add Accommodation Fee Request</button>
                            @endif
                    </div>
                    <div class="col-12">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Accommodation Fee Request</h5>
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div id="DivRegion" style="display: none;">
                                    <div class="form-row mb-1">
                                        ...
                                        <div class="col-3">
                                            <label class="small font-weight-bold text-dark">Company Cut Precentage*</label>
...
<div class="modal fade" id="viewModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header p-2">
                <h5 class="viewmodal-title" id="staticBackdropLabel">View Accommodation Fee Request Details</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="app_modal-title" id="staticBackdropLabel">Approve Accommodation Fee Request Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script>
    ...
    $("#employeerequest").addClass('navbtnactive');
        ...
        $('#dataTable').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: scripturl + '/accommodationfeelist.php',
            ...
            "buttons": [{
                    ...
                    title: 'Accommodation Fee Request Details',
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        if (statuscheck) {
                                if (full['status'] == 1) {
                                    button += ' <a href="accommodationfeesstatus/' + full['id'] + '/2 " onclick="return deactive_confirm()" target="_self" class="btn btn-outline-success btn-sm mr-1 "><i class="fas fa-check"></i></a>';
                                } else {
                                    button += '&nbsp;<a href="accommodationfeesstatus/' + full['id'] + '/1 "  onclick="return active_confirm()" target="_self" class="btn btn-outline-warning btn-sm mr-1 "><i class="fas fa-times"></i></a>';
                                }
                        }
                        if (deletecheck) {
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Add Accommodation Fee Request');
        ...
        $('#btncreateorder').click(function () {
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('accommodationfeesinsert') }}";
            }
            if ($('#action').val() == 'Edit') {
                action_url = "{{ route('accommodationfeesupdate') }}";
            }
            if (!isAnyFieldEmpty) {
//  console.log(requesttype,supplier,location,discount_presentage,month,remark,hidden_id);
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                url: '{!! route("accommodationfeesedit") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id
                ...
                success: function (data) {
                    ...
                    $('#hidden_id').val(id);
                    $('.modal-title').text('Edit Accommodation Fee Request');
        ...
        $('#ok_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("accommodationfeesdelete") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: user_id
        ...
        $(document).on('click', '.appL1', function () {
            ...
            $.ajax({
                url: '{!! route("accommodationfeesdetailapprovel_details") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_approve
...
// console.log(tableDataArray);
            ...
            $.ajax({
                url: '{!! route("accommodationfeesapprove") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_hidden,
