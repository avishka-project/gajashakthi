                        ...
                        <div class="row">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="col-4">
                                    ...
                                    <br>
                                    <label><input type="checkbox" name="selectAll" id="selectAllDomainList" /> Check
                                        All</label>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="form-group mt-2">
                                    <button type="button" name="btncreateorder" id="btncreateorder"
                                        class="btn btn-outline-primary btn-sm fa-pull-right px-4"><i
                                            class="fas fa-plus"></i>&nbsp;Add Attendance</button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-group mt-2">
                                    <button type="button" name="btnupdate" id="btnupdate"
                                        class="btn btn-outline-primary btn-sm fa-pull-right px-4"><i
                                            class="fas fa-plus"></i>&nbsp;Edit Attendance</button>
