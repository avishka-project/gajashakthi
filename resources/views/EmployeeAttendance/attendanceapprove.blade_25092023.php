...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on("change", "#branch", function () {
                ...
                $('#dataTable').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                        url: "{!! route('attendanceapprovelist') !!}",
                        type: "POST",
                        data: function (d) {
                            return $.extend({}, d, {
                                "cusid": $("#branch").val()
      ...
      $('#customer').change(function () {
            ...
            if (customerId !== '') {
                $.ajax({
                    url: '{!! route("getsubcustomersattendance", ["customerId" => "id_customer"]) !!}'.replace('id_customer', customerId),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
        ...
        $('#subcustomer').change(function () {
            ...
            if (subcustomerId !== '') {
                $.ajax({
                    url: '{!! route("getbranchattendance", ["subcustomerId" => "id_subcustomer"]) !!}'.replace('id_subcustomer', subcustomerId),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        $('#branch').empty().append(
