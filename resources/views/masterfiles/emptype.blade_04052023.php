    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body p-0 p-2">
                    <div class="row">
                        <div class="col-12">
                                <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Type</button>
                        </div>
                        <div class="col-12">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Add Employee Type</h5>
                                ...
                                <form method="post" id="formTitle" class="form-horizontal">
                                    ...
                                    <div class="form-row mb-1">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="emptype" id="emptype" class="form-control form-control-sm" required/>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Approve Employee Type</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('typeinsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('typeupdate') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $('#emptype').val(data.result.emptype);
                        $('#hidden_id').val(id);
            ...
            $(document).on('click', '.appL1', function () {
                ...
                $.ajax({
                    url: '{!! route("typeedit") !!}',
                        ...
                        data: {id: id_approve },
                    success: function (data) {
                        $('#approve_emptype').val(data.result.emptype);
