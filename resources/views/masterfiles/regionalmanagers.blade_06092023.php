...
@section('content')
    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body p-0 p-2">
                    <div class="row">
                        <div class="col-12">
                                <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Regional Managers</button>
                        </div>
                        <div class="col-12">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Add Regional Managers</h5>
                                ...
                                <form method="post" id="formTitle" class="form-horizontal">
                                    {{ csrf_field() }}
                                      <div class="form-row mb-1">
                                        <div class="col-12">
                                        <label class="small font-weight-bold text-dark">Regional Manager</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Approve Regional Manager Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#create_record').click(function(){
                $('.modal-title').text('Add New Regional Manager');
            ...
            $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('regionalmangerinsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('regionalmangerupdate') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#hidden_id').val(id);
                        $('.modal-title').text('Edit Regional Manager');
            ...
            $('#ok_button').click(function () {
                ...
                $.ajax({
                    url: '{!! route("regionalmangerdelete") !!}',
                        type: 'POST',
                        dataType: "json",
                        data: {id: user_id },
                    beforeSend: function () {
            ...
            $('#approve_button').click(function () {
                ...
                $.ajax({
                    url: '{!! route("regionalmangerapprove") !!}',
                        type: 'POST',
                        dataType: "json",
                        data: {id: id_hidden,
                            applevel: applevel
