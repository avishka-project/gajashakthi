    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body p-0 p-2">
                    <div class="row">
                        <div class="col-12">
                                <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Region</button>
                        </div>
                        <div class="col-12">
                                ...
                                <form method="post" id="formTitle" class="form-horizontal">
                                    ...
                                    <div class="form-row mb-1">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="region" id="region" class="form-control form-control-sm" required/>
                                        </div>
                                    </div>
                                    <div class="form-row mb-1">
                                        <label class="small font-weight-bold text-dark">Regional Officer</label>
        ...
        <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Approve Region Details</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal">
                            <div class="form-row mb-1">
                                <div class="col-12">
                                    <label class="small font-weight-bold text-dark">Region*</label>
                                    <input type="text" name="app_region" id="app_region" class="form-control form-control-sm" readonly/>
                                </div>
                            </div>
                            <div class="form-row mb-1">
                                <label class="small font-weight-bold text-dark">Regional Officer</label>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('regioninsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('regionupdate') }}";
                }
