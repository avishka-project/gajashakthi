        ...
        <div class="container-fluid">
            <div class="page-header-content py-3">
                <h1 class="page-header-title">
                    ...
                    <span>Employee Details - Security Staff</span>
                </h1>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="employeecategory" id="empcat" class="form-control form-control-sm shipClass {{ $errors->has('employeecategory') ? ' has-error' : '' }}">
                                            ...
                                            @foreach($employeecat as $empcategory)
                                                <option value="{{$empcategory->id}}" @if($empcategory->id == 2) selected @endif>{{$empcategory->emp_category}}</option>
                                            @endforeach
                                        </select>
...
$(document).ready(function () {
    ...
    $('#securityemployee_main_nav_link').prop('aria-expanded', 'true').removeClass('collapsed');
    ...
    function load_dt(department, employee, from_date, to_date){
        ...
        $('#emptable').DataTable({
                ...
                "serverSide": true,
                ajax: {
                    url: scripturl + '/securityemployeelist.php',
