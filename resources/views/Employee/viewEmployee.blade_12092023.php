								...
								<div class="card-body bg-light">
									...
									<div class="form-row mb-1">
										...
										<div class="col">
											...
											<input type="email" name="emp_email" id="emp_email" value="{{$employee->emp_email}}" class="form-control form-control-sm {{ $errors->has('emp_email') ? ' has-error' : '' }}" />
										...
										<div class="col">
											...
											<input type="email" name="emp_other_email" id="emp_other_email" value="{{$employee->emp_other_email}}" class="form-control form-control-sm {{ $errors->has('emp_other_email') ? ' has-error' : '' }}" />
						...
						<div class="card-body bg-light">
							...
							<div class="form-row">
								<div class="col">
									...
									<select name="region_id" id="region_id"  class="form-control form-control-sm shipClass {{ $errors->has('region_id') ? ' has-error' : '' }}">
										<option value="">Select</option>
								...
								<div class="col">
									...
									<select name="subregion_id" id="subregion_id"  class="form-control form-control-sm shipClass {{ $errors->has('subregion_id') ? ' has-error' : '' }}">
										<option value="">Select</option>
								...
								<div class="col">
									...
									<select name="emptype_id" id="emptype_id"  class="form-control form-control-sm shipClass {{ $errors->has('emptype_id') ? ' has-error' : '' }}">
										<option value="">Select</option>
							...
							<div class="form-group mt-3 text-right">
								@can('employee-edit')
									<button type="submit" class="btn btn-outline-primary btn-sm  px-4"><i class="fas fa-pencil-alt mr-2"></i>&nbsp;Update</button>
								@endcan
							</div>
							</div>
							</div>
					...
					<div class="col-12">
						...
						<form class="form-horizontal" method="POST" action="{{ route('empoyeeAttachment') }}" enctype="multipart/form-data">
							...
							<div class="form-group mt-3">
								@can('employee-edit')
									<button type="submit" name="" id="" class="btn btn-outline-primary btn-sm fa-pull-right px-4"><i class="fas fa-save"></i>&nbsp;Add Attachments</button>
								@endcan
							</div>
