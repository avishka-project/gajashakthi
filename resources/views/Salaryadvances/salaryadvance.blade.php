                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record"
                            id="create_record"><i class="fas fa-plus mr-2"></i>Add Salary Advance Request</button>
                            @endif
                    </div>
                    <div class="col-12">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Salary Advance Request</h5>
...
<div class="modal fade" id="viewModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header p-2">
                <h5 class="viewmodal-title" id="staticBackdropLabel">View Salary Advance Request Details</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    $("#employeerequest").addClass('navbtnactive');
        ...
        $('#dataTable').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: scripturl + '/salaryadvanceslist.php',
            ...
            "buttons": [{
                    ...
                    title: 'Salary Advance Request Details',
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        if (statuscheck) {
                                if (full['status'] == 1) {
                                    button += ' <a href="salaryadvancestatus/' + full['id'] + '/2 " onclick="return deactive_confirm()" target="_self" class="btn btn-outline-success btn-sm mr-1 "><i class="fas fa-check"></i></a>';
                                } else {
                                    button += '&nbsp;<a href="salaryadvancestatus/' + full['id'] + '/1 "  onclick="return active_confirm()" target="_self" class="btn btn-outline-warning btn-sm mr-1 "><i class="fas fa-times"></i></a>';
                                }
                        }
                        if (deletecheck) {
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Add Salary Advance Request');
        ...
        $('#btncreateorder').click(function () {
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('salaryadvanceinsert') }}";
            }
            if ($('#action').val() == 'Edit') {
                action_url = "{{ route('salaryadvanceupdate') }}";
            }
            if (!isAnyFieldEmpty) {
//  console.log(requesttype,supplier,location,discount_presentage,month,remark,hidden_id);
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#hidden_id').val(id);
                    $('.modal-title').text('Edit Salary Advance Request');
        ...
        $(document).on('click', '.appL1', function () {
            ...
            $.ajax({
                url: '{!! route("salaryadvancedetailapprovel_details") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_approve
        ...
        $('#approve_button').click(function () {
            ...
            var empid = $(this).find('td#empid').text();
            var amount = $(this).find('td#boardingfee').text();
...
// console.log(tableDataArray);
            ...
            $.ajax({
                url: '{!! route("salaryadvanceapprove") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_hidden,
