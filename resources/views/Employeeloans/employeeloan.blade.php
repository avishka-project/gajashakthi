                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record"
                            id="create_record"><i class="fas fa-plus mr-2"></i>Add Employee Loan Request</button>
                            @endif
                    </div>
                    <div class="col-12">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Employee Loan Request</h5>
...
<div class="modal fade" id="viewModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header p-2">
                <h5 class="viewmodal-title" id="staticBackdropLabel">View Employee Loan Request Details</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="modal fade" id="approveconfirmModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="app_modal-title" id="staticBackdropLabel">Approve Employee Loan Request Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script>
    ...
    $("#employeerequest").addClass('navbtnactive');
        ...
        $('#dataTable').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: scripturl + '/employeeloanslist.php',
            ...
            "buttons": [{
                    ...
                    title: 'Employee Loan Request Details',
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        if (statuscheck) {
                                if (full['status'] == 1) {
                                    button += ' <a href="employeeloanstatus/' + full['id'] + '/2 " onclick="return deactive_confirm()" target="_self" class="btn btn-outline-success btn-sm mr-1 "><i class="fas fa-check"></i></a>';
                                } else {
                                    button += '&nbsp;<a href="employeeloanstatus/' + full['id'] + '/1 "  onclick="return active_confirm()" target="_self" class="btn btn-outline-warning btn-sm mr-1 "><i class="fas fa-times"></i></a>';
                                }
                        }
                        if (deletecheck) {
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Add Employee Loan Request');
        ...
        $('#btncreateorder').click(function () {
            ...
            if(requesttype=="voregion"){
                ...
                if(location!='' && month!=''){
                    ...
                    var loan = $(this).find('input[type="number"]').val();
                    var rowData = {
                        'empid': empid,
                        'loan': loan,
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('employeeloaninsert') }}";
            }
            if ($('#action').val() == 'Edit') {
                action_url = "{{ route('employeeloanupdate') }}";
            }
            if (!isAnyFieldEmpty) {
//  console.log(requesttype,supplier,location,discount_presentage,month,remark,hidden_id);
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#hidden_id').val(id);
                    $('.modal-title').text('Edit Employee Loan Request');
        ...
        $(document).on('click', '.appL1', function () {
            ...
            $.ajax({
                url: '{!! route("employeeloandetailapprovel_details") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_approve
        ...
        $('#approve_button').click(function () {
            ...
            var empid = $(this).find('td#empid').text();
            var loan = $(this).find('td#boardingfee').text();
...
function getAllVoEmp() {
        ...
        $.ajax({
            url: '{!! route("employeeloanGetAllEmployee") !!}',
            type: 'POST',
            dataType: "json",
            data: {
