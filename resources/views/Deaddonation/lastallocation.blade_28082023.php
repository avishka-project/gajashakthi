                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-row mb-1">
                            <div class="col-12">
                                <label class="small font-weight-bold text-dark">Bank*</label>
                                <input type="text" id="app_bank" name="app_bank"
                                    class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        <div class="form-row mb-1">
...
<script>
    $(document).ready(function () {
        ...
        $('#lastallocation_link').addClass('active');

        $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                "url": "{!! route('lastallocationlist') !!}",
        ...
        $('#formTitle').on('submit', function (event) {
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('lastallocationinsert') }}";
            }
            if ($('#action').val() == 'Edit') {
                action_url = "{{ route('lastallocationupdate') }}";
            }
        ...
        $('#ok_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("lastallocationdelete") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: user_id,
        ...
        $('#approve_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("lastallocationapprove") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: id_hidden,
