    ...
    $(document).ready(function () {
        ...
        $("#formsubmit").click(function () {
            if (!$("#formTitle")[0].checkValidity()) {
                ...
                $('#tableorder > tbody:last').append('<tr class="pointer"><td>' + customer +
                    ...
                    '</td><td class="text-center">' + guardrate + '</td><td class="text-center">' + extra_otrate + '</td><td class="d-none">' +
        ...
        $("#formsubmit2").click(function () {
            ...
            $('#tableorder2> tbody:last').append('<tr class="pointer"><td>' + title + '</td><td>' +
                companyrate + '</td><td>' + guardrate + '</td><td>' + extra_otrate + '</td><td class="d-none">' + titleID +
...
<script>
    $(document).ready(function () {
        ...
        $('#customer').change(function () {
            ...
            if (customerId !== '') {
                $.ajax({
                    url: '{!! route("getsubcustomers", ["customerId" => "id_customer"]) !!}'.replace('id_customer',customerId),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
        ...
        $('#subcustomer').change(function () {
            ...
            if (subcustomerId !== '') {
                $.ajax({
                    url: '{!! route("getbranch", ["subcustomerId" => "id_subcustomer"]) !!}'.replace('id_subcustomer',subcustomerId),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        $('#area').empty().append(
