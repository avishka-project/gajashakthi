                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    <div class="col">
                                        <label class="small font-weight-bold text-dark">Extra OT Rate*</label>
                                        <input type="number" id="extra_otrate" name="extra_otrate"
                                            class="form-control form-control-sm" required>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <div class="form-row mb-1">
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Extra OT Rate*</label>
                                    <input type="number" id="extra_otrate2" name="extra_otrate2"
                                        class="form-control form-control-sm" required>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                        ...
                        <div class="col-4">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <div class="col">
                                        <label class="small font-weight-bold text-dark">Holiday Type</label>
                                        <select name="app_holiday" id="app_holiday" class="form-control form-control-sm"
                                            required>
...
<script>
    $(document).ready(function () {
        ...
        $("#formsubmit").click(function () {
            if (!$("#formTitle")[0].checkValidity()) {
                ...
                $('#tableorder > tbody:last').append('<tr class="pointer"><td>' + customer +
                    ...
                    '</td><td class="text-center">' + guardrate + '</td><td class="text-center">' +
                    extra_otrate + '</td><td class="d-none">' +
        ...
        $("#formsubmit2").click(function () {
            if ($('#title2').val() === '' || $('#companyrate2').val() === '' || $('#guardrate2')
            .val() === '' || $('#extra_otrate2').val() === '') {
                $("#submitBtn2").click();
            } else {
        ...
        $(document).on('click', '.btnEditlist', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#companyrate2').val(data.result.companyrate);
                    $('#guardrate2').val(data.result.guardrate);
                    $('#extra_otrate2').val(data.result.extra_otrate);
        ...
        $('#ok_button2').click(function () {
            ...
            $.ajax({
                url: '{!! route("employeerequestdetaildelete") !!}',
                type: 'POST',
                dataType: "json",
                data: {
                    id: rowid,
...
<script>
 ...
 $('#subcustomer').change(function () { 
             ...
             if (subcustomerId !== '') {
                $.ajax({
                    url: '{!! route("getbranchsubcustomerfilter", ["subcustomerId" => "id_subcustomer", "customerId" => "id_customer"]) !!}'.replace('id_subcustomer', subcustomerId).replace('id_customer', customerId),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        $('#area').empty().append(
