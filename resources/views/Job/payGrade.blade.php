    ...
    <div class="container-fluid mt-4">
        <div class="card">
            <div class="card-body p-0 p-2">
                <div class="row">
                    <div class="col-12">
                        @can('pay-grade-create')
                            <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Grade</button>
                        @endcan
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <table class="table table-striped table-bordered table-sm small nowrap display" style="width: 100%" id="paygradetable">
                            <thead>
                                <tr>
                                    <th>ID </th>
                                    <th>Pay Grade</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        @can('pay-grade-edit')
                                            <button name="edit" id="{{$paygrades->id}}" class="edit btn btn-outline-primary btn-sm" type="submit"><i class="fas fa-pencil-alt"></i></button>
                                        @endcan
                                        @can('pay-grade-delete')
                                            <button type="submit" name="delete" id="{{$paygrades->id}}" class="delete btn btn-outline-danger btn-sm"><i class="far fa-trash-alt"></i></button>
                                        @endcan
                                    </td>
                                </tr>
                                @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Pay Grade</h5>
...
$(document).ready(function(){
    ...
    $('#pay_grade_link').addClass('active');
