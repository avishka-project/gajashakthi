...
class Attendance extends Model
{
    ...
    //                     $holiday_check_in = Holiday::where('date', $on_time)
    //                         ->where('work_level', '=', '2')
    //                         ->first();

    //                     $holiday_check_out = Holiday::where('date', $ot_ends_morning)
    //                         ->where('work_level', '=', '2')
    //                         ->first();
    ...
    //                     if($holiday_check_in){
    //                         $in_date = $on_time->format('Y-m-d');
    //                         $ot_in_minutes_morning_i = $on_time->diffInMinutes($in_date. ' 00:00:00');
    //                         $double_ot_hours_morning = round($ot_in_minutes_morning_i / 60, 2);
    //                         $total_ot_hours_double += $double_ot_hours_morning;

    //                         $ot_in_minutes_morning_ii = $ot_ends_morning->diffInMinutes($ot_ends_morning. ' 00:00:00');
    //                         $ot_hours_morning = round($ot_in_minutes_morning_ii / 60, 2);
    //                         $total_ot_hours += $ot_hours_morning;
    //                         $is_holiday = true;
    //                     }

    //                     if($holiday_check_out){
    //                         $out_date = $ot_ends_morning->format('Y-m-d');
    //                         $ot_out_minutes_morning_i = $ot_ends_morning->diffInMinutes($out_date. ' 00:00:00');
    //                         $double_ot_hours_morning = round($ot_out_minutes_morning_i / 60, 2);
    //                         $total_ot_hours_double += $double_ot_hours_morning;

    //                         $ot_out_minutes_morning_ii = $ot_ends_morning->diffInMinutes($ot_ends_morning. ' 00:00:00');
    //                         $ot_hours_morning = round($ot_out_minutes_morning_ii / 60, 2);
    //                         $total_ot_hours += $ot_hours_morning;
    //                         $is_holiday = true;
    //                     }
    ...
    //                         $holiday_check_in = Holiday::where('date', $ot_starts_evening)
    //                             ->where('work_level', '=', '2')
    //                             ->first();

    //                         $holiday_check_out = Holiday::where('date', $off_time)
    //                             ->where('work_level', '=', '2')
    //                             ->first();
    ...
    //                         if($holiday_check_in){
    //                             $in_date = $ot_starts_evening->format('Y-m-d');
    //                             $double_ot_hours_evening_i = $ot_starts_evening->diffInMinutes($in_date. ' 00:00:00');
    //                             $double_ot_hours_evening = round($double_ot_hours_evening_i / 60, 2);
    //                             $total_ot_hours_double += $double_ot_hours_evening;

    //                             $double_ot_hours_evening_ii = $off_time->diffInMinutes($off_time. ' 00:00:00');
    //                             $ot_hours_evening = round($double_ot_hours_evening_ii / 60, 2);
    //                             $total_ot_hours += $ot_hours_evening;
    //                             $is_holiday = true;
    //                         }

    //                         if($holiday_check_out){
    //                             $out_date = $off_time->format('Y-m-d');
    //                             $double_ot_hours_evening_i = $off_time->diffInMinutes($out_date. ' 00:00:00');
    //                             $double_ot_hours_evening = round($double_ot_hours_evening_i / 60, 2);
    //                             $total_ot_hours_double += $double_ot_hours_evening;

    //                             $ot_out_minutes_evening_ii = $off_time->diffInMinutes($off_time. ' 00:00:00');
    //                             $ot_hours_evening = round($ot_out_minutes_evening_ii / 60, 2);
    //                             $total_ot_hours += $ot_hours_evening;
    //                             $is_holiday = true;
    //                         }
    ...
    //                         $holiday_check_out = Holiday::where('date', $next_date_morning)
    //                             ->where('work_level', '=', '2')
    //                             ->first();
    ...
    //                         if($holiday_check_in){
    //                             $in_date = $ot_starts_evening->format('Y-m-d');
    //                             $ot_in_minutes_morning_i = $ot_starts_evening->diffInMinutes($in_date. ' 00:00:00');
    //                             $double_ot_hours_morning = round($ot_in_minutes_morning_i / 60, 2);
    //                             $total_ot_hours_double += $double_ot_hours_morning;

    //                             $ot_in_minutes_morning_ii = $next_date_morning->diffInMinutes($next_date_morning. ' 00:00:00');
    //                             $ot_hours_morning = round($ot_in_minutes_morning_ii / 60, 2);
    //                             $total_ot_hours += $ot_hours_morning;
    //                             $is_holiday = true;
    //                         }
    ...
    //                         if($holiday_check_out){
    //                             $out_date = $next_date_morning->format('Y-m-d');
    //                             $ot_out_minutes_morning_i = $next_date_morning->diffInMinutes($out_date. ' 00:00:00');
    //                             $double_ot_hours_morning = round($ot_out_minutes_morning_i / 60, 2);
    //                             $total_ot_hours_double += $double_ot_hours_morning;

    //                             $ot_out_minutes_morning_ii = $next_date_morning->diffInMinutes($next_date_morning. ' 00:00:00');
    //                             $ot_hours_morning = round($ot_out_minutes_morning_ii / 60, 2);
    //                             $total_ot_hours += $ot_hours_morning;
    //                             $is_holiday = true;
    //                         }
