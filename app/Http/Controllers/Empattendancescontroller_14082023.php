...
class Empattendancescontroller extends Controller
{
    ...
    public function allocationlist(Request $request){
        ...
        $requests = DB::table('empallocations')
                ...
                ->whereBetween('empallocations.date', [$sevenDaysAgo, $currentDate])
...
private function allocationdetailslist($id){
    ...
    ->leftjoin('shift_types', 'empallocations.shift_id', '=', 'shift_types.id')
    ->select('empallocationdetails.*', 'job_titles.title','employees.emp_fullname','shift_types.onduty_time AS ontime','shift_types.offduty_time AS offtime','empallocations.date AS allocation_date')
