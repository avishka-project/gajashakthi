...
private function app_reqestcountlist($id){
   ...
   ->select('employeepayments.*', 'job_titles.title','employeepaymentdetails.companyrate' ,'employeepaymentdetails.guardrate','employeepaymentdetails.job_title_id', DB::raw('(employeepaymentdetails.id) AS employeepaymentdetailsID'))
...
public function update(Request $request){
    ...
    foreach ($tableData as $rowtabledata) {
        ...
        }else if($rowtabledata['col_5'] == "NewData") {
            $companyrate = $rowtabledata['col_2'];
            $guardrate = $rowtabledata['col_3'];
            $titleID = $rowtabledata['col_4'];
                if($titleID != 0){
