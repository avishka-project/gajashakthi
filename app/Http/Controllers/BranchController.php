...
class Branchcontroller extends Controller
{
    public function index()
    {
        ...
        $clients = Customer::orderBy('id', 'asc')
        ->whereIn('customers.status', [1, 2])
        ->where('customers.approve_status', 1)
        ->get();
        $subclients = Subcustomer::orderBy('id' ,'asc')
        ->whereIn('subcustomers.status', [1, 2])
        ->where('subcustomers.approve_status', 1)
        ->get();

        return view('Customers.branch' , compact('subregions','clients' ,'subclients'));
    }
    ...
    public function insert(Request $request){
        ...
        $branchName = addslashes($request->input('cusname'));

        $customer->branch_name = $branchName;
        ...
        $customer->subcustomer_id = $request->input('subcustomer');
    ...
    public function list()
    {
        ...
        //     ->leftjoin('subcustomers','customerbranches.subcustomer_id','=','subcustomers.id')
        //     ->select('customerbranches.*' ,'subregions.subregion','subcustomers.sub_name')
    ...
    public function update(Request $request){
        ...
        $form_data = array(
                ...
                'subcustomer_id' => $request->subcustomer,
                'approve_status' =>  '0',
                'approve_01' =>  '0',
                'approve_02' =>  '0',
                'approve_03' =>  '0',
