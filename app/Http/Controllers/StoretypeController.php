...
class StoretypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Store.storetype',compact('userPermissions'));
    }
        ...
        $types = DB::table('storetypes')
            ...
            ->addColumn('action', function ($row) {
                ...
                $userPermissions = $commen->Allpermission();
                        ...
                        if(in_array('StoreType-edit',$userPermissions)){
                            if($row->approve_status == 0 ){
                                $btn .= ' <button name="edit" id="'.$row->id.'" class="edit btn btn-outline-primary btn-sm" type="submit"><i class="fas fa-pencil-alt"></i></button>'; 
                            }
                        }

                        if(in_array('StoreType-status',$userPermissions)){
                            if($row->status == 1){
                        ...
                        if(in_array('StoreType-delete',$userPermissions)){
