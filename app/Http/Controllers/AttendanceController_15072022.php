...
class AttendanceController extends Controller
{
    ...
    public function attendance_by_time_report_list(Request $request)
    {
        ...
        foreach ($records as $record) {
            ...
            $first_time_stamp = date('h:i:s A', strtotime($record->timestamp));
...
//            ->delete();
    ...
    public function get_ot_details(Request $request)
    {
        ...
        foreach ($attendance_data as $att) {
            ...
            $ot_hours = (new \App\Attendance)->get_ot_hours_by_date($emp_id, $att->lasttimestamp, $att->timestamp, $date, $att->onduty_time, $att->offduty_time, $att->emp_department);
