...
class Newbusinessproposalcontroller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Newbusinessproposal.newbusinessproposal',compact('employees'));
    }

    
    public function insert(Request $request){
        $user = Auth::user();
        $permission =$user->can('Newbusinessproposal-create');
        if(!$permission) {
        ...
        $mobilebillpayment->company_name = $request->input('company_name');
        $mobilebillpayment->month = $request->input('month'); 
        $mobilebillpayment->contact_person = $request->input('contact_person');
        $mobilebillpayment->contact_number = $request->input('contact_number');
        ...
        return response()->json(['success' => 'Business Proposal is successfully Inserted']);
    }

    public function requestlist()
    {
        $types = DB::table('newbusinessproposals')
            ->join('employees', 'newbusinessproposals.emp_id', '=', 'employees.id')
    ...
    public function update(Request $request){
        ...
        return response()->json(['success' => 'Business Proposal is Successfully Updated']);
    }
