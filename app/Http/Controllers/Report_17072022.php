...
//        }
        ...
        foreach ($data_arr as $dept_key => $department_data) {
            ...
            foreach ($department_data as $emp_data) {
                ...
                foreach ($emp_data as $attendance)
                {
                    ...
                    if($attendance['workhours'] == '00:00:00'){
                    ...
                    $html .= '<td>'.$attendance['timestamp'].'</td>';
    ...
    public function ot_report_list_view_more(Request $request) {
        ...
        $ot_hours = (new \App\Attendance)->get_ot_hours_by_date($emp_id, $attendance_data[0]->lasttimestamp, $attendance_data[0]->timestamp, $date, $attendance_data[0]->onduty_time, $attendance_data[0]->offduty_time, $attendance_data[0]->emp_department);
        ...
        $att_data = array(
            ...
            'check_in_time' => $attendance_data[0]->timestamp,
    ...
    public function get_no_pay_amount($emp_etfno, $emp_work, $emp_leave, $emp_nopay, $emp_ot_i, $emp_ot_ii  ){
            ...
            return $figs_list['NOPAY']['fig_val'];
    ...
    public function no_pay_report_list_month(Request $request)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('no_pay_days_data', function ($row) use ($month) {
                ...
                $no_pay_amount = $this->get_no_pay_amount($row->emp_id, $work_days, $leave_days, $no_pay_days, $normal_rate_otwork_hrs, $double_rate_otwork_hrs);
