...
class Branchcontroller extends Controller
{
    public function index()
    {
        ...
        ->get();
        $customer = Subcustomer::orderBy('id', 'asc')
    ...
    public function insert(Request $request){
        ...
        $customer->subcustomer_id = $request->input('customer_id');
    ...
    public function list()
    {
        $types = DB::table('customerbranches')
            ...
            ->join('subcustomers','customerbranches.subcustomer_id','=','subcustomers.id')
    ...
    public function update(Request $request){
        ...
        $form_data = array(
                ...
                'subcustomer_id' => $request->customer_id,
                'approve_status' =>  '0',
                'approve_01' =>  '0',
                'approve_02' =>  '0',
                'approve_03' =>  '0',
