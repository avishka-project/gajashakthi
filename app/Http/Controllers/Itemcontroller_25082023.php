...
class Itemcontroller extends Controller
{
    ...
    {
        $categories = DB::table('itemcategories')->select('itemcategories.*')->get();
        return view('Items.item',compact('categories'));
    }
    public function insert(Request $request){
        ...
        $item->re_order_level = $request->input('reorderlevel');
    ...
    public function requestlist()
    {
        $types = DB::table('items')
            ->join('itemcategories', 'items.category_id', '=', 'itemcategories.id')
            ->select('items.*','itemcategories.category_name AS category_name')
