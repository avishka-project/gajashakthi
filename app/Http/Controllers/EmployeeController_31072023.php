...
//            'no_of_annual_leaves'  => 'required_if:status,2'
    ...
    public function show($id)
    {
        ...
        // $attachments = EmployeeAttachment::where('emp_id', $employee->emp_id)->where('emp_ath_type', 'employee')->get();
        $employee_picture = EmployeePicture::where('emp_id', $employee->emp_id)->latest()->first();

        return view('Employee.viewEmployee', compact( 'job_categories', 'employee', 'id', 'jobtitles', 'employmentstatus', 'branch', 'shift_type', 'company', 'departments', 'employee_picture'));
    }
