...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Employee.employeeAdd', compact('newid', 'employmentstatus', 'branch', 'device', 'title', 'shift_type', 'company', 'departments','listpermission','fingerprintpermission','editpermission','deletepermission'));
    }
