...
class EmpallocationController extends Controller
{
    ...
    public function list(Request $request){
        ...
        $requests = DB::table('empallocations')
                    ->join('customers', 'empallocations.customer_id', '=', 'customers.id')
                    ->join('customerbranches', 'empallocations.customerbranch_id', '=', 'customerbranches.id')
                    ->join('shift_types', 'empallocations.shift_id', '=', 'shift_types.id')
    ...
    public function requestdetails(Request $request){
                ...
                $data = DB::table('customerrequests')
                            ...
                            ->join('customerbranches', 'customerrequests.customerbranch_id', '=', 'customerbranches.id')
                            ->join('shift_types', 'customerrequests.shift_id', '=', 'shift_types.id')
                            // ->join('holidays', 'customerrequests.holiday_id', '=', 'holidays.id')
        ...
        if(!$permission) {
            ...
            $id = Request('id');
                $data = DB::table('empallocations')
                    ->join('customers', 'empallocations.customer_id', '=', 'customers.id')
                    ->join('subcustomers', 'empallocations.subcustomer_id', '=', 'subcustomers.id')
                    ->join('customerbranches', 'empallocations.customerbranch_id', '=', 'customerbranches.id')
                    ->join('shift_types', 'empallocations.shift_id', '=', 'shift_types.id')
                    //->join('holidays', 'empallocations.holiday_id', '=', 'holidays.id')
    ...
    private function reqestcountlist($id){
        ...
        $data = DB::table('customerrequests')
        ->join('customerrequestdetails', 'customerrequestdetails.customerrequest_id', '=', 'customerrequests.id')
        ->join('empallocations', 'customerrequests.id', '=', 'empallocations.request_id')
        ->join('job_titles', 'customerrequestdetails.job_title_id', '=', 'job_titles.id')
        ->select('customerrequests.*', 'job_titles.title','customerrequestdetails.count')
    ...
    private function allocationdetailelist($id){
        ...
        ->join('empallocations', 'empallocationdetails.allocation_id', '=', 'empallocations.id')
        ->join('job_titles', 'empallocationdetails.assigndesignation_id', '=', 'job_titles.id')
        ->join('employees','empallocationdetails.emp_id','=','employees.id')
