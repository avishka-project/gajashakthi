...
class Employeepaymentcontroller extends Controller
{
    ...
    public function index()
    {
        ...
        $subcustomers = DB::table('subcustomers')->select('subcustomers.*')->get();
    ...
    public function displayemployeepayment(Request $request)
    {
        ...
        $requests = DB::table('employeepayments')
                    ->leftjoin('customers', 'employeepayments.customer_id', '=', 'customers.id')
                    ->leftjoin('subcustomers', 'employeepayments.subcustomer_id', '=', 'subcustomers.id')
                    ->leftjoin('customerbranches', 'employeepayments.customerbranch_id', '=', 'customerbranches.id')
                    //   ->join('job_titles', 'employeepaymentdetails.job_title_id', '=', 'job_titles.id')
                    ->leftjoin('shift_types', 'employeepayments.shift_id', '=', 'shift_types.id')
                     ->leftjoin('holiday_types', 'employeepayments.holiday_type_id', '=', 'holiday_types.id')
    ...
    public function approvel_details(Request $request){
        ...
        ->select('employeepayments.*','customers.name','customerbranches.branch_name','employeepaymentdetails.job_title_id','employeepaymentdetails.companyrate','employeepaymentdetails.guardrate', 'employeepaymentdetails.extra_otrate','subcustomers.sub_name')
        ->whereIn('employeepayments.status', [1, 2])
        ->where('employeepayments.id', $id)
        //->groupBy('employeepayments.customer_id', 'employeepayments.subcustomer_id','employeepaymentdetails.job_title_id','employeepaymentdetails.companyrate','employeepaymentdetails.guardrate', 'employeepaymentdetails.extra_otrate','employeepayments.customerbranch_id')
        ->get();
...
public function deletelist(Request $request){
    ...
    Employeepaymentdetail::findOrFail($id)
    ->update($form_data);
