...
$extraWhere = "`u`.`deleted` = 0 AND `u`.`emp_category` = 1";

 if($department != ''){
	$extraWhere = " `ue`.`id` = '$department' AND `u`.`emp_category` = 1 AND `u`.`deleted` = 0";
 }
 if ($employee != ''){
	$extraWhere = "`u`.`id` = '$employee' AND `u`.`emp_category` = 1 AND `u`.`deleted` = 0";
 }
...
//  }
 ...
 if ($from_date != '' && $to_date != ''){
	$extraWhere = "`u`.emp_join_date BETWEEN '$from_date' AND '$to_date' AND `u`.`emp_category` = 1 AND `u`.`deleted` = 0";
 }
